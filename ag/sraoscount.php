...
<body>
	...
	echo	"<tr>
		...
		$query0=" select ps_nm DAG from prsnl_infrmtn_systm 
		          where ps_cdr_id in ('DA00','DA01','DA02','DA04','DA05','DA07','DA08')
		          and ps_flg='W' ";
	   ...
	   // $conds=" q1.bid=q2.bid and q1.wngid=q2.wngid and q1.DAG=q2.DAG and q1.branch=q2.branch ";
	     $conds=" q0.DAG=q2.DAG(+)  and q0.DAG=q1.DAG(+) ";
	    $query= "select q1.bid bid,q1.wngid wngid,q0.DAG dag,q1.branch branch,q1.count_srao hq,q2.count_srao fld 
	             from (".$query0.") q0,(".$query1.") q1,(".$query2.") q2 
