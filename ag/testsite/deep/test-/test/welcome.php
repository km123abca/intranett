...
<button class=" tablink"  onclick="openPage('Home1', this, 'red')" id="defaultOpen">Employee details
</button>


<button class="tablink" onclick="openPage('Home2', this, 'green')" >Reports</button>
<button class="tablink" onclick="openPage('Home3', this, 'blue')">Payslip</button>
<button class="tablink" onclick="openPage('Home4', this, 'orange')">Photos</button>
<button class="tablink" onclick="openPage('Home5', this, 'green')" id="secdef">Appove leave</button>
<button class="tablink" onclick="openPage('Home6', this, 'black')" id="thdef">Apply for leave</button>
<button class="tablink" onclick="openPage('Home7', this, 'blue')" id="fodef">Reset Password</button>
 <script>
...
<fieldset>
	...
	<lab class="llg bl">From</lab><inp class="llg">:<input type="text" id="fd" name="fd" placeholder="dd/mm/yyyy"></inp>
	<lab class="llg bl">To</lab><inp class="llg">:<input type="text" id="td" name="td" placeholder="dd/mm/yyyy"></inp>
	<lab class="llg bl">No of days</lab><inp class="llg" >:<input type="text" id="days" name="days"
