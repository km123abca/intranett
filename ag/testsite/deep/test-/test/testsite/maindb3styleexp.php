...
<f class="lg md sm">Basic Pay   :<input type="text" name="bpay" id ="bpay" size="20"></f>
<DA id="f" class="lg">DA: <input type="text" name="da" id="da" size="20"></DA>
<TA id="f" class="lg">TA: <input type="text" name="ta" id="ta" size="20"></TA>
<DAONTA id="f" class="lg">DA on TA: <input type="text" name="daonta" id="daonta" size="20"></DAONTA>
<HRA id="f" class="lg">HRA:    <input type="text" name="hra" id="hra" size="20" ></HRA>
<GPF id="f" class="lg">GPF:    <input type="text" name="gpf" id="gpf" size="20" ></GPF>



<CGGIS id="f" class="lg md sm">CGGIS:    <input type="text" name="cggis" id="cggis" size="20" ></CGGIS>
<CGHS id="f" class="lg md sm">CGHS:    <input type="text" name="cghs" id="cghs" size="20" ></CGHS>
<licence id="f" class="lg md sm">License Fee:    <input type="text" name="licence" id="licence" size="20" ></licence>
<protax id="f" class="lg md sm">Professional Tax:    <input type="text" name="pt" id="pt" size="20" ></protax>
<IT id="f" class="lg md sm">Income Tax:    <input type="text" name="it" id="it" size="20" ></IT>


<ITSUR id="f" class="lg md sm">IT Surcharge:    <input type="text" name="itsur" id="itsur" size="20" ></ITSUR>
<Trvry id="f" class="lg md sm">Total Recovery:    <input type="text" name="tr" id="tr" size="20" ></Trvry>
<netpay id="f" class="lg md sm">Net Pay:    <input type="text" name="net" id="net" size="20" ></netpay>
<Tier1 id="f" class="lg md sm">TierI:    <input type="text" name="t1" id="t1" size="20" ></Tier1>
