...
<h1 id="offheading">  Persons who joined between specific dates</h1>
</head>
 

<body>

<form method="post" action="joiningwisedisplayHelper.php">
<fieldset>
  ...
  <f class="lg bl">Wing</f>   <inp class="lg">:<select id="wing1" name="wing1" onchange="wingchanged(this.value)"  >
     ...
     <f class="lg bl">Branch</f> <inp class="lg">:<select id="branch" name="branch" onchange="branchchanged(this.value)" >
      ...
      <f class="lg bl">Location</f><inp class="lg">:<select id="loc" name="loc">
	    ...
	    <f class="lg bl">start date</f><inp class="lg">:<input type='text' name='sdate' placeholder="DD/MM/YY"></inp>
	    <f class="lg bl">end date</f><inp class="lg">:<input type='text' name='edate'  placeholder="DD/MM/YY"></inp>
		   
 <input type="submit" name="submit" value="Generate"> 
 
 </fieldset>
 </form>
 <a href="orarepo_v3.php">Go back to reports</a>
