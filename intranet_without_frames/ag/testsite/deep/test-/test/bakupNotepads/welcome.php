...
<input type="submit" name="submit" value="Search" class='maindbbutton'>  
...
<div id="Home2" class="tabcontent">
  <h3>Various Reports for administrative uses</h3>
  <fieldset>
