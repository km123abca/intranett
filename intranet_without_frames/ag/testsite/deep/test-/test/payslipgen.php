...
// Page header
			...
			function Header()
				{
   				 // Logo
    			$this->Image($this->imfil,150,35,30);
    			// Arial bold 15
...
if (file_exists("images/$idno.jpg")) $pdf->setimgg("images/$idno.jpg");
$pdf->AliasNbPages();
$pdf->AddPage();
...
<h1 id="titlle">Office of the Accountants General, Thiruvananthapuram</h1>
</head>
