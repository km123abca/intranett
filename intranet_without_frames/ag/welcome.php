...
<button class="tablink" onmouseover="openPage('Home2', this, 'green')" >Reports</button>
<button class="tablink" onmouseover="openPage('Home3', this, 'blue')">Payslip</button>
<button class="tablink" onmouseover="openPage('Home4', this, 'orange')">Photos</button>
<button class="tablink" onmouseover="openPage('Home5', this, 'green')" id="secdef">Appove leave</button>
<button class="tablink" onmouseover="openPage('Home6', this, 'black')" id="thdef">Apply for leave</button>
<button class="tablink" onmouseover="openPage('Home7', this, 'blue')" id="fodef">Reset Password</button>
 <script>
