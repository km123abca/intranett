...
<?php
    ...
    $branch=$_SESSION["repobran"];
     ...
     $query="select ps_idn idd,ps_nm namee,ps_floor levell,sec.dmn_dscrptn sectionn,wng.dmn_dscrptn wingg,
              last_day(add_months(ps_dt_of_brth,720)) retdate from prsnl_infrmtn_systm a,estt_dmn_mstr sec,estt_dmn_mstr wng
...
$q2="var queryy ="."\"select ps_idn idd,ps_nm namee,ps_floor levell,sec.dmn_dscrptn sectionn,wng.dmn_dscrptn wingg ,";
     $q2.=" last_day(add_months(ps_dt_of_brth,720)) retdate from ";
	...
	$q2.=" and last_day(add_months(ps_dt_of_brth,720)) between ".$sdate." and ".$edate;
...
function rearrange(str)
	{//console.log(queryy);
	    ...
	    var headerText="<tr>"+
	    				...
	    				"<th><button type=\"button\" onclick=#>DOR </button></th>" +
	    				"</tr>";
