...
//require_once("./include/membersite_config.php");
 //include_once('../../iwfheader_for_chat.php');
?>
<head>
<title>Chat with your colleagues</title>
<script>
lastReceived=0;
...
<marquee scrolldelay='50' scrollamount='10' truespeed  style='background-color:black;font-size: 36;color:white;font-weight: bold;'  >
			Type your name in the sign in box and press sign in, no password is required
...
<chat1 id='hea2'>Chat with your colleagues</chat1>
<!--
